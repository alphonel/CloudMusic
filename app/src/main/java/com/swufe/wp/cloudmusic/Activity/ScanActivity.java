...
import com.swufe.wp.cloudmusic.Info.MusicInfo;
import com.swufe.wp.cloudmusic.Service.MusicService;
import com.swufe.wp.cloudmusic.utils.ChineseToEnglish;
...
import com.swufe.wp.cloudmusic.utils.SelectorUtil;
import com.swufe.wp.cloudmusic.View.ScanView;
import com.swufe.wp.cloudmusic.Fragment.AlbumFragment;
import com.swufe.wp.cloudmusic.utils.Common;
            ...
            public void run() {
                ...
                try {
                    String[] muiscInfoArray = new String[]{
                            ...
                            MediaStore.Audio.Media.ALBUM_ID,            //歌曲的专辑ID
                    ...
                    if (cursor!= null && cursor.getCount() != 0){
                        ...
                        while (cursor.moveToNext()) {
                            ...
                            String albumbip = getAlbumArt(albumID);
                            Bitmap bm = null;
                            if (albumbip != null) {
                                bm = BitmapFactory.decodeFile(albumbip);
                            } else {
                                bm = BitmapFactory.decodeResource(getResources(), R.mipmap.changpian);
                            }
                            musicInfo.setAlbumBip(bm);
                            ...
                            Common.mMusicDatas.add(musicInfo);

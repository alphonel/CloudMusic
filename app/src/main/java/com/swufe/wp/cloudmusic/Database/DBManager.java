package com.swufe.wp.cloudmusic.Database;
...
import static com.swufe.wp.cloudmusic.Database.DatabaseHelper.ID_COLUMN;
import static com.swufe.wp.cloudmusic.Database.DatabaseHelper.MUSIC_ID_COLUMN;
...
//            values.put(DatabaseHelper.ID_COLUMN, musicInfo.getId());
            ...
            values.put(DatabaseHelper.ALBUM_ID_COLUMU, musicInfo.getAlbumID());
        } catch (Exception e) {
            e.printStackTrace();
        }
        return values;

...
import com.swufe.wp.cloudmusic.Adapter.HomeListViewAdapter;
import com.swufe.wp.cloudmusic.Database.DBManager;
import com.swufe.wp.cloudmusic.Info.PlayListInfo;
...
import com.swufe.wp.cloudmusic.utils.HttpUtil;
import com.swufe.wp.cloudmusic.utils.MyApplication;
...
//                        overridePendingTransition(R.anim.start_anim,R.anim.out_anim);
                    ...
                    case R.id.nav_logout:
                        finish();
                        Intent intentBroadcast = new Intent(MusicService.PLAYER_MANAGER_ACTION);
                        intentBroadcast.putExtra(Constant.COMMAND, Constant.COMMAND_RELEASE);
                        sendBroadcast(intentBroadcast);
                        Intent stopIntent = new Intent(HomeActivity.this,MusicService.class);
        ...
        init();
        Intent startIntent = new Intent(HomeActivity.this,MusicService.class);

package com.swufe.wp.cloudmusic.Receiver;
...
import com.swufe.wp.cloudmusic.utils.UpdateUIThread;
...
public class PlayerManagerReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_UPDATE_UI_ADAPTER = "com.swufe.wp.cloudmusic.Receiver.PlayerManagerReceiver:action_update_ui_adapter_broad_cast";
